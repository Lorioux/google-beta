...
can set, consult the implementation in [provider.go](https://github.com/lorioux/google-beta/blob/main/google-beta/provider.go)
and [config.go](https://github.com/lorioux/google-beta/blob/main/google-beta/config.go).
