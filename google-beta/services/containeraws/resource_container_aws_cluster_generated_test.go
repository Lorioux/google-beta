...
func TestAccContainerAwsCluster_BetaBasicEnumHandWritten(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerAwsCluster_BetaBasicEnumHandWritten(context),
			},
			{
				ResourceName:            "google_container_aws_cluster.primary",
				ImportState:             true,
			...
			{
				Config: testAccContainerAwsCluster_BetaBasicEnumHandWrittenUpdate0(context),
			},
			{
				ResourceName:            "google_container_aws_cluster.primary",
				ImportState:             true,
...
func testAccContainerAwsCluster_BetaBasicEnumHandWritten(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_aws_versions" "versions" {
  provider = google-beta
  project = "%{project_name}"
...
func testAccContainerAwsCluster_BetaBasicEnumHandWrittenUpdate0(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_aws_versions" "versions" {
  provider = google-beta
  project = "%{project_name}"
