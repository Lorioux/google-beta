...
func TestAccContainerAwsNodePool_BetaBasicEnumHandWritten(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerAwsNodePool_BetaBasicEnumHandWritten(context),
			},
			{
				ResourceName:            "google_container_aws_node_pool.primary",
				ImportState:             true,
...
func testAccContainerAwsNodePool_BetaBasicEnumHandWritten(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_aws_versions" "versions" {
  provider = google-beta
  project = "%{project_name}"
...
func testAccContainerAwsNodePool_BetaBasicEnumHandWrittenUpdate0(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_aws_versions" "versions" {
  provider = google-beta
  project = "%{project_name}"
